<?php
    $sql_suabv="select * from baivietvl where id_baiviet='$_GET[id_baiviet]' limit 1 ";
    //limit sửa giới hạn  1 sản phẩm
    $query_suabv= mysqli_query($mysqli,$sql_suabv);
?>
<p>Sửa bài viết việc làm<p>
...
<form method="POST" action="modules/qlbvvl/xuly.php?id_baiviet=<?php echo $row['id_baiviet'] ?>"  enctype="multipart/form-data" >
<tr>
    <td>Ngành nghề</td>
    <td>
  ...
  <tr>
    <td>Tên việc làm</td>
    <td><input type="text" value="<?php echo $row['tenvieclam'] ?>" name="tenvieclam"></td>
  </tr>
...
<tr>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="modules/qlbvvl/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
  </td>
  </tr>
